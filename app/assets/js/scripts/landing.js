...
function setNewsLoading(val){
    if(val){
        const nLStr = 'Recherche des nouveautés'
        let dotStr = '...'
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                // JQuery Element
                    ...
                    // Resolve date.
                    const date = new Date(el.find('pubDate').text()).toLocaleDateString({month: 'short', day: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric'})
